...
describe RailsDatatables::Base do
  class Column
    def matches(query)
      []
    end
  ...
  describe 'an instance' do
    it 'requires a view_context' do
      expect{ RailsDatatables::Base.new }.to raise_error
    end

    it 'accepts an options hash' do
      datatable = RailsDatatables::Base.new(view, { :foo => 'bar' })
  ...
  describe 'helper methods' do
    describe '#offset' do
      it 'defaults to 0' do
        ...
        datatable = RailsDatatables::Base.new(default_view)
      ...
      it 'matches the value on view params[:iDisplayStart] minus 1' do
        ...
        datatable = RailsDatatables::Base.new(paginated_view)
    ...
    describe '#per_page' do
      it 'defaults to 10' do
        datatable = RailsDatatables::Base.new(view)
      ...
      it 'matches the value on view params[:iDisplayLength]' do
        ...
        datatable = RailsDatatables::Base.new(other_view)
    ...
    describe '#sort_direction' do
      it 'matches value of params[:sSortDir_0]' do
        ...
        datatable = RailsDatatables::Base.new(sorting_view)
  ...
  describe 'perform' do
    ...
    describe '#filter_records' do
      ...
      it 'applies search like functionality on a collection' do
        datatable = RailsDatatables::Base.new(search_view)
